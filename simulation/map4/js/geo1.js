...
$(function()
{
	...
	$('#solidtable td').on('click',function()
	{
		...
		if(p == 1 && q == 1 && r == 1 && s == 1 && t == 1 && u == 1 && v == 1 && w == 1 && x == 1)
		{
			...
			generateQuestion(q1,"________dotted lines and _______solid lines are identified in this map","","11 & 10","9 & 12","11 & 9","10 & 11",3,nextButtonProceed,100,150,300,150);	
		}
...
function gameLoop()
{
	...
	else if(grid_size*ball.y/100<-stopPoint)
		drawScreen();
}
...
function drawTunnel110()
{
	...
	if (tun2x<=1510) requestAnimationFrame(drawTunnel110) 
		if(tun2x>1510)
		{
			...
			generateQuestion(q2,"A 20m depth horizontal tunnel is proposed at an altitude of _______m from x axis parallel to it, between bounds.:","","120","1500","1200","1100",3,nextButtonProceed,100,150,300,140);
		}
}

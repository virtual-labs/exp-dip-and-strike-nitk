...
$(function () {
  ...
  $("#calci").click(function () {
    ...
    if (solidline == 0) {
      ...
      setTimeout(function () {
        $("#can8-7").html(
          "Index=(400*(1165-1100)+500*(1210-1165))/(1210-1100)"
        );
        document.getElementById("can8-7").style.visibility = "visible";
      }, 7500);
      setTimeout(function () {
      ...
      setTimeout(function () {
        $("#can8-7").html(
          "Index=(200*(1385-1330)+300*(1420-1385))/(1420-1330)"
        );
        document.getElementById("can8-7").style.visibility = "visible";
      }, 7500);
      setTimeout(function () {
...
$("#step15-1").click(function () {
  ...
  $("#resultContainer").html(
    '<img id="ctmap" style="position: absolute; left: 55px; top: 120px;" src="images/ctrmap2.png"/>'
  );
});
...
function magic() {
  if (simsubscreennum == 1) {
    ...
    generateQuestion(
      q1,
      "How many geological cross-sections are taken in this map?",
      "",
      "1",
      "2",
      "3",
    ...
    generateQuestion(
      q2,
      "Formula to calculate index value of solidline for &alpha; &lt; &beta;:",
      "",
      "Index=(N*(¥- α )+M*( β-¥))/( β- α) ",
      "Index= (N*(α- ¥)+M*(¥- β))/( α- β)",
      "Index=(N*(¥+α )+M*( β+¥))/( β+α) ",
...
let animationRunning = false; // Animation completed

...
function magic()
{
	...
	else if(simsubscreennum == 8)
	{
		...
		generateQuestion(q2,"Formula to calculate index value of solidline for &alpha; &lt; &beta;:","","Index=(N*(¥- α )+M*( β-¥))/( β- α) ","Index= (N*(α- ¥)+M*(¥- β))/( α- β)","Index=(N*(¥+α )+M*( β+¥))/( β+α) ","None of the above",1,doNothing,60,100,230,150);	
